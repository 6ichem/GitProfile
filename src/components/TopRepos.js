    ...
    <div className='container m-auto pb-24'>
      <div className='dropdown-wrapper mb-3'>
        ...
        <div className='dropdown inline-block relative'>
          <button className='text-indigo-500 p-2 rounded inline-flex items-center'>
            <span className='mr-1'>{sortType}</span>
            <svg
          ...
          <ul className='dropdown-menu absolute text-indigo-500	pt-1'>
            {loading ? (
              <Loader
                type='Puff'
                color='#00BFFF'
